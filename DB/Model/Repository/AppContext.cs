    ...
    public class AppContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var providersParts = new List<ProviderPart>
            {
                ...
                new ProviderPart { Id = 30, ProviderId = 2, PartId = 19 }
            };
            modelBuilder.Entity<ProviderPart>().HasData(providersParts.ToArray());

            var deals = new List<Deal>
            {
                new Deal { Id = 1 , Date = DateTime.Parse("2018.08.15"), ProviderPartId = 23, Count = 1 },
                new Deal { Id = 2 , Date = DateTime.Parse("2018.08.19"), ProviderPartId = 23, Count = 4 },
                new Deal { Id = 3 , Date = DateTime.Parse("2018.08.19"), ProviderPartId = 17, Count = 2 },
                new Deal { Id = 4 , Date = DateTime.Parse("2018.08.21"), ProviderPartId = 17, Count = 3 },
                new Deal { Id = 5 , Date = DateTime.Parse("2018.09.06"), ProviderPartId = 17, Count = 1 },
                new Deal { Id = 6 , Date = DateTime.Parse("2018.08.26"), ProviderPartId = 17, Count = 1 },
                new Deal { Id = 7 , Date = DateTime.Parse("2018.08.26"), ProviderPartId = 18, Count = 2 },
                new Deal { Id = 8 , Date = DateTime.Parse("2018.08.30"), ProviderPartId = 18, Count = 5 },
                new Deal { Id = 9 , Date = DateTime.Parse("2018.09.02"), ProviderPartId = 11, Count = 2 },
                new Deal { Id = 10, Date = DateTime.Parse("2018.09.03"), ProviderPartId = 23, Count = 7 },
                new Deal { Id = 11, Date = DateTime.Parse("2018.09.07"), ProviderPartId = 1 , Count = 4 },
                new Deal { Id = 12, Date = DateTime.Parse("2018.09.08"), ProviderPartId = 1 , Count = 1 },
                new Deal { Id = 13, Date = DateTime.Parse("2018.09.08"), ProviderPartId = 13, Count = 3 },
                new Deal { Id = 14, Date = DateTime.Parse("2018.09.09"), ProviderPartId = 13, Count = 2 },
                new Deal { Id = 15, Date = DateTime.Parse("2018.09.11"), ProviderPartId = 14, Count = 6 },
                new Deal { Id = 16, Date = DateTime.Parse("2018.08.23"), ProviderPartId = 14, Count = 1 },
                new Deal { Id = 17, Date = DateTime.Parse("2018.08.27"), ProviderPartId = 14, Count = 2 },
                new Deal { Id = 18, Date = DateTime.Parse("2018.08.15"), ProviderPartId = 19, Count = 1 },
                new Deal { Id = 19, Date = DateTime.Parse("2018.08.19"), ProviderPartId = 19, Count = 4 },
                new Deal { Id = 20, Date = DateTime.Parse("2018.08.19"), ProviderPartId = 20, Count = 2 },
                new Deal { Id = 21, Date = DateTime.Parse("2018.08.21"), ProviderPartId = 20, Count = 3 },
                new Deal { Id = 22, Date = DateTime.Parse("2018.09.06"), ProviderPartId = 20, Count = 1 },
                new Deal { Id = 23, Date = DateTime.Parse("2018.09.26"), ProviderPartId = 20, Count = 1 },
                new Deal { Id = 24, Date = DateTime.Parse("2018.09.26"), ProviderPartId = 24, Count = 2 },
                new Deal { Id = 25, Date = DateTime.Parse("2018.08.30"), ProviderPartId = 3 , Count = 5 },
                new Deal { Id = 26, Date = DateTime.Parse("2018.08.30"), ProviderPartId = 25, Count = 5 },
                new Deal { Id = 27, Date = DateTime.Parse("2018.09.02"), ProviderPartId = 4 , Count = 2 },
                new Deal { Id = 28, Date = DateTime.Parse("2018.08.09"), ProviderPartId = 4 , Count = 2 },
                new Deal { Id = 29, Date = DateTime.Parse("2018.08.03"), ProviderPartId = 5 , Count = 7 },
                new Deal { Id = 30, Date = DateTime.Parse("2018.08.04"), ProviderPartId = 5 , Count = 2 },
                new Deal { Id = 31, Date = DateTime.Parse("2018.08.03"), ProviderPartId = 26, Count = 1 },
                new Deal { Id = 32, Date = DateTime.Parse("2018.08.28"), ProviderPartId = 12, Count = 4 },
                new Deal { Id = 33, Date = DateTime.Parse("2018.09.18"), ProviderPartId = 21, Count = 1 },
                new Deal { Id = 34, Date = DateTime.Parse("2018.08.17"), ProviderPartId = 15, Count = 3 },
                new Deal { Id = 35, Date = DateTime.Parse("2018.09.25"), ProviderPartId = 27, Count = 2 },
                new Deal { Id = 36, Date = DateTime.Parse("2018.08.13"), ProviderPartId = 6 , Count = 6 },
                new Deal { Id = 37, Date = DateTime.Parse("2018.09.24"), ProviderPartId = 6 , Count = 1 },
                new Deal { Id = 38, Date = DateTime.Parse("2018.09.26"), ProviderPartId = 6 , Count = 2 },
                new Deal { Id = 39, Date = DateTime.Parse("2018.09.17"), ProviderPartId = 7 , Count = 6 },
                new Deal { Id = 40, Date = DateTime.Parse("2018.08.14"), ProviderPartId = 28, Count = 1 },
                new Deal { Id = 41, Date = DateTime.Parse("2018.08.20"), ProviderPartId = 28, Count = 2 },
                new Deal { Id = 42, Date = DateTime.Parse("2018.09.12"), ProviderPartId = 30, Count = 1 },
                new Deal { Id = 43, Date = DateTime.Parse("2018.09.11"), ProviderPartId = 30, Count = 4 },
                new Deal { Id = 44, Date = DateTime.Parse("2018.09.13"), ProviderPartId = 8 , Count = 2 },
                new Deal { Id = 45, Date = DateTime.Parse("2018.08.29"), ProviderPartId = 8 , Count = 3 },
                new Deal { Id = 46, Date = DateTime.Parse("2018.09.25"), ProviderPartId = 22, Count = 1 },
                new Deal { Id = 47, Date = DateTime.Parse("2018.08.26"), ProviderPartId = 22, Count = 1 },
                new Deal { Id = 48, Date = DateTime.Parse("2018.09.26"), ProviderPartId = 9 , Count = 2 },
                new Deal { Id = 49, Date = DateTime.Parse("2018.08.17"), ProviderPartId = 10, Count = 5 },
                new Deal { Id = 50, Date = DateTime.Parse("2018.09.17"), ProviderPartId = 29, Count = 2 }
            };
